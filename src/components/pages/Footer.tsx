          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="flex space-x-5 pt-2">
                  <Link href="#" className="text-gray-400 hover:text-yellow-400 transition-colors duration-200">
              ...
              >
                ...
                <ul className="space-y-3 text-gray-300">
                  ...
                  <li>
                    <Link href="/sobre" className="hover:text-yellow-400 transition-colors duration-200">
                      Sobre a Cognitec
                    </Link>
                  </li>
                  <li>
                    <Link href="/servicos" className="hover:text-yellow-400 transition-colors duration-200">
                      Serviços
                    </Link>
                  </li>
                  <li>
                    <Link href="/termos" className="hover:text-yellow-400 transition-colors duration-200">
                      Termos de Uso
                    </Link>
                  </li>
                  <li>
                    <Link href="/privacidade" className="hover:text-yellow-400 transition-colors duration-200">
              ...
              <motion.div
                ...
                className="space-y-5"
              >
                <h3 className="text-lg font-semibold tracking-wide">Nossos Serviços</h3>
                <ul className="space-y-3 text-gray-300">
                  <li>
                    <Link
              ...
              >
                ...
                <p className="text-gray-300 text-sm">Assine nossos serviços e fique por dentro da Cognitec!</p>
            ...
            >
              <div className="flex flex-col md:flex-row justify-between items-center">
                <p className="text-xs text-gray-500">© 2025 Cognitec — Todos os direitos reservados</p>
                <p className="text-xs text-gray-500 mt-2 md:mt-0">
                  Desenvolvido pela equipe da CogniTec • Consultoria em Acessibilidade
                </p>
              </div>
            </motion.div>
          </motion.div>
